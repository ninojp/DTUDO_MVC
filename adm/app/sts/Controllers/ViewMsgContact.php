...
class ViewMsgContact
{
    ...
    public function index(int|string|null $id = null): void
    {
        if (!empty($id)) {
            ...
            $viewMsgContact = new \App\sts\Models\StsViewMsgContact();
            $viewMsgContact->viewMsgContact($this->id);
            if ($viewMsgContact->getResult()) {
                $this->data['viewMsgContact'] = $viewMsgContact->getResultBd();
            ...
            $_SESSION['msg'] = "<p class='alert alert-warning'>Erro (index(controller))! (ID)Registro não encontrado!</p>";
            $urlRedirect = URLADM."list-msg-contact/index";
            header("Location: $urlRedirect");
        }
    }
    ...
    private function loadViewMsgContact():void
    {
        ...
        $loadView = new \App\sts\core\ConfigViewSts("sts/Views/contact/viewMsgContact", $this->data);
