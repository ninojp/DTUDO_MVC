...
<div class="wrapper_form">
    <div class="row_form">
        ...
        <form class="form_adms" action="" method="POST" id="form-add-sit-user">
            ...
            <div class="row_edit">
                <label class="" for="name">Editar Situação:</label>
            ...
            <div class="button_center">
                <a class="btn btn-sm btn-outline-success mx-2" href="<?=URLADM;?>list-sits-users/index">Listar</a>
                <?php if (isset($valorForm['id'])){
                    echo "<a class='btn btn-sm btn-outline-warning mx-2' href='".URLADM."view-sits-users/index/".$valorForm['id']."'> Visualizar </a><br><hr>";
                    echo "<a class='btn btn-sm btn-outline-danger mx-2' href='".URLADM."delete-sits-users/index/".$valorForm['id']."' onclick='return confirm(\"Tem certeza que deseja excluir o registro?\")'><i class='fa-solid fa-trash-can'></i> Apagar</a>"; }?>
            </div>
        </form>
    </div>
</div>