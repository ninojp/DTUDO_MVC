...
class AdmsViewAccessNivels
{
    ...
    */
    public function viewAccessNivels(int $id):void
    {
        ...
        $viewAccessNivels->fullRead("SELECT id, name, order_levels, created, modified FROM adms_access_levels WHERE id=:id AND order_levels > :order_levels LIMIT :limit", "id={$this->id}&order_levels=".$_SESSION['order_levels']."&limit=1");
