...
class AdmsListAccessNivels
{
    ...
    public function listAccessNivels(int $page = null): void
    {
        ...
        $listAccessesNivels->fullRead("SELECT id, name, order_levels FROM adms_access_levels WHERE id > :order_levels ORDER BY id ASC LIMIT :limit OFFSET :offset", "order_levels=".$_SESSION['order_levels']."&limit={$this->limitResult}&offset={$pagination->getOffset()}");
